...
|  Create an SCP to require tags when anyone creates new resources\. For an example, see [Example 12: Require a tag upon resource creation](orgs_manage_policies_scps_examples.md#example-require-tag-on-create)\.  |  The organization's master account\.¹  |  [AWS Organizations](https://console.aws.amazon.com/organizations/)  | 
