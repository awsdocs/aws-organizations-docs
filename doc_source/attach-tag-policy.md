...
1. On the **[Organize accounts](https://console.aws.amazon.com/organizations/home#/browse)** tab, navigate to and then choose the check box next to the root, OU, or account that you want to attach a tag policy to\. You might have to expand OUs \(choose the \+ next to an OU name\) in the navigation pane to find the OU or account that you want\.

1. In the details pane on the right, under **POLICIES**, expand the entry for **Tag policies** by choosing it\.

1. Find the tag policy that you want and choose **Attach**\.
...
1. On the **[Tag policies](https://console.aws.amazon.com/organizations/home#/policies/tag)** page, choose the policy that you want to attach\.
...
1. On the **[Organize accounts](https://console.aws.amazon.com/organizations/home#/browse)** tab, navigate to and then choose the check box next to the root, OU, or account that you want to detach a tag policy from\. You might have to expand OUs \(choose the \+ next to an OU name\) in the navigation pane to find the OU or account that you want\.

1. In the details pane, under **POLICIES**, expand the entry for **Tag policy** by choosing it\.

1. Find the tag policy that you want and choose **Detach**\.
