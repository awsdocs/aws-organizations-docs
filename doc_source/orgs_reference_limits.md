...
|  Maximum size of a [service control policy \(SCP\)](orgs_manage_policies_type-auth.md#orgs_manage_policies_scp) document  |  5,120 bytes\. White space \(such as spaces and line breaks\) between JSON elements and outside of quotation marks, is not counted\.   | 
