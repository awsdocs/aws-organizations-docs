...
An SCP can restrict what users and even administrators can do in affected accounts\. The master account can apply SCPs that can prevent member accounts from leaving the organization\. Ensure that your account administrators are aware of this\.
