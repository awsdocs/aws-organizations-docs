...
For more information on policy inheritance, including examples of how the inheritance operators work and example effective tag policies, see [Understanding policy inheritance](orgs_manage_policies-inheritance.md)\.
