...
Allow lists and deny lists are complementary techniques for when you apply [SCPs](orgs_manage_policies_type-auth.md#orgs_manage_policies_scp) to filter the permissions that are available to accounts\.  
